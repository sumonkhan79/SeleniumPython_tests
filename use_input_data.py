...
sheet = client.open('TextInput').sheet1

# Let's get all the data from the  sheet 1
all_values=sheet.get_all_values()

#print(all_values)

# Get the values we want out of the data- input sheet
input_data = []
for row in all_values[1:]:
    input_data.append(row[1])
print(input_data)

# use selenium to put the data in the box
